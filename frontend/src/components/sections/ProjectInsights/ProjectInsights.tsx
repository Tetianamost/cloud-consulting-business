...
const projectHighlights = [
	{
		...
		description:
			'Learn about our professional experience and AWS certifications that form the foundation of our cloud consulting services.',
		challenges: [
		...
		solution:
			'We bring our 5+ combined AWS certifications and years of professional cloud experience to help businesses with targeted cloud solutions. Our flexible scheduling means we can adapt to your specific timeline needs.',
		results: {
		...
		testimonial: {
			quote:
				"We're passionate about cloud technology and love helping businesses leverage it effectively with our flexible schedule that adapts to your needs.",
	...
	},
	{
		...
		description:
			"Our deep knowledge of AWS architecture and infrastructure design helps businesses build scalable, secure, and cost-effective cloud environments.",
		challenges: [
		...
		solution:
			'We leverage our extensive AWS certification knowledge and practical experience to design robust cloud architectures tailored to your specific business requirements and growth plans.',
		results: {
		...
		testimonial: {
			quote:
				'Our approach combines technical expertise with a practical understanding of business needs, resulting in cloud solutions that deliver real value for your organization.',
			author: 'Cloud Partner Pro Team',
...
const MemoizedProjectInsights = React.memo(ProjectInsights);
export default MemoizedProjectInsights;