    ...
    it('should adapt email statuses when system metrics are null', () => {
      const emailStatuses: EmailStatus[] = [
        ...
        },
        {
          ...
          delivered_at: new Date('2024-01-01T11:00:00Z'),
        ...
        },
        {
          ...
          delivered_at: new Date('2024-01-01T12:03:00Z'),
          error_message: '',
        },
      ];
      ...
      const emailStatuses: EmailStatus[] = [
        {
          ...
          status: 'failed',
          sent_at: new Date('2024-01-01T10:00:00Z'),
          delivered_at: new Date('2024-01-01T10:00:00Z'),
    ...
    it('should handle mixed email statuses correctly', () => {
      const emailStatuses: EmailStatus[] = [
        ...
        },
        {
          ...
          consultant_email: 'consultant@example.com',
          status: 'failed',
          sent_at: new Date('2024-01-01T13:00:00Z'),
          delivered_at: new Date('2024-01-01T13:00:00Z'),
      ...
      const emailStatuses: EmailStatus[] = [
        {
          ...
          delivered_at: new Date('2024-01-15T10:02:30Z'),
          error_message: '',
        },
        {
          ...
          consultant_email: 'info@cloudpartner.pro',
          status: 'delivered',
          sent_at: new Date('2024-01-15T11:15:00Z'),
          delivered_at: new Date('2024-01-15T11:16:45Z'),
          error_message: '',
        },
      ];
