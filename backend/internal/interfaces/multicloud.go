...
type MultiCloudAnalyzer interface {
	...
	AnalyzeCosts(ctx context.Context, workload WorkloadSpec) (*MultiCloudCostAnalysis, error)
...
// MultiCloudCostAnalysis represents cost analysis results for multicloud comparison
